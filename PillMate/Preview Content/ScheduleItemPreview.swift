...
extension ScheduledDose {
    ...
    static var sampleItems: [ScheduledDose] {
        [
            ScheduledDose(id: UUID(), scheduledTime:Calendar.current.date(from: DateComponents(year: 2025, month: 9, day: 11,hour: 22, minute: 00))!, status: true, nitificacionIdentifier: "uno", medication: InformationMedication(medicationName: "Amoxicilina", medicationPresentation: "pastillas", medicationDose: "1", medicationUnit: "ML/MG", medicationFrequency: "cada día", medicationtTimePerDay: 3, medicationFirstDoseTime: Date(), medicationMomentDose: "Despues de comer", medicationCustomInstructions: "Con agua", medicationTreatmentStartDate: Date(), treatmentDuration: "")),
            ScheduledDose(id: UUID(), scheduledTime: Calendar.current.date(from: DateComponents(year: 2025, month: 9, day: 2,hour: 20, minute: 00))!, status: false, nitificacionIdentifier: "dos", medication: InformationMedication(medicationName: "Paracetamol", medicationPresentation: "pastillas", medicationDose: "1", medicationUnit: "", medicationFrequency: "cada día", medicationtTimePerDay: 3, medicationFirstDoseTime: Date(), medicationMomentDose: "Despues de comer", medicationCustomInstructions: "Con agua", medicationTreatmentStartDate: Date(), treatmentDuration: "")),
            ScheduledDose(id: UUID(), scheduledTime: Calendar.current.date(from: DateComponents(year: 2025, month: 9, day: 2,hour: 23, minute: 00))!, status: false, nitificacionIdentifier: "tres", medication: InformationMedication(medicationName: "Ibuprofeno", medicationPresentation: "pastillas", medicationDose: "1", medicationUnit: "", medicationFrequency: "cada día", medicationtTimePerDay: 3, medicationFirstDoseTime: Date(), medicationMomentDose: "Despues de comer", medicationCustomInstructions: "Con agua", medicationTreatmentStartDate: Date(), treatmentDuration: "")),
